        ...
        <div class="encapsule">
            <div class="box pt-3 ml-4 mr-4">
                <div class="d-flex justify-content-center">
                    <img style="width: 65px;" src="../../assets/failed.png" alt="image9">
                </div>
                <div class="d-flex justify-content-center mt-3">
                    <p class="failed">Transfer Failed</p>
                </div>
                <div class="d-flex justify-content-center">
                <p class="text">We can’t transfer your money at the moment, we recommend you to check your internet connection and try again.</p>
                </div>
                    ...
                    <div class="box-user mt-3 mb-3">
                        <div class="flex-box1">
                            ...
                            <div class="box-profile1 ml-5 mt-2">
                                <p class="name1 mb-2">{{receiver.username}}</p>
                                <p class="phone1">{{receiver.phoneNumber}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end pb-2">
                        <router-link class="button" :to="{path: '/main/home'}">Try Again</router-link>
                    </div>
                </div>
            </div>
        </div>
